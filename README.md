...
- Medical NLP research community for pre-trained models
...
- [Medical NLP Papers](docs/references.md)

## 📧 Contact

- **Issues**: [GitHub Issues](https://github.com/yourusername/medassist-pro/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/medassist-pro/discussions)
